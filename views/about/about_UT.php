...
<div id="tabs_container">
      ...
      <ul class="tabs">
        <li class="active">
          <a href="#" rel="#tab_1_contents" class="tab"><strong>High Tech Industry</strong></a>
        </li>
        <li><a href="#" class="tab" rel="#tab_2_contents"><strong>Libraries located on campus</strong></a></li>
        <li><a href="#" class="tab" rel="#tab_3_contents"><strong>Library next to the iSchool</strong></a></li>
        <li><a href="#" class="tab" rel="#tab_4_contents"><strong>Others</strong></a></li>
        <li><a href="#" class="tab" rel="#tab_5_contents"><strong>Archive Center</strong></a></li>
      </ul>
