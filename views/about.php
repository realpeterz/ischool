 <div id="rightcolumn" class="grid_9 about">
            ...
            <P>Our focus is on information in its social context, from a single user searching for a document, to a government determining the access of its citizenry to public records. Our work reaches into schools and corporations, design companies and libraries, museums and archives, wherever people search for, read and store documented knowledge.</P><img src="images/mission.jpg" align="right" />
              ...
              <ul>
                <li> Our school ranks in the Top 10 nationally, and #1 in Archives & Preservation</li>
                <li>Over 90% of students are professionally employed within nine months of graduation</li>
                <li>Our alumni hold leadership positions at the state and national levels</li>
                <li>Our doctoral graduates hold faculty positions in some of the top schools in the nation</li>
                <li>We provide a dedicated Careers Office to assist alumni throughout their careers</li>
                <li>UT Austin is home to world class collections in the arts and humanities</li>
                <li>With selective admission and a flexible curriculum, we provide education for a lifelong career</li>
              </ul>
              <p><a href="http://www.ischool.utexas.edu/about/vision.php">our mission in detail</a> </p>
</div>
