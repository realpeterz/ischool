  ...
  <div class="container_12" id="container">
     ...
     <div id="header" class="grid_12">
        ...
        <div id="icons" class="">
					<ul>
						<li>
							<a href="http://blogs.ischool.utexas.edu/ischoolyou/"><img src="images/social_icons/podcast.png" alt="podcast icon" title='podcast'/></a>
						</li>
						<li>
						...
						<li>
							<a href="http://www.facebook.com/pages/UT-iSchool/81784648743"><img src="images/social_icons/facebook.png" alt="facebook icon" title='facebook'/></a>
						</li>
					</ul>
        </div> <!-- end of icons -->
   ...
   <div id="search-container">
    	<div id="wrap-search">
	 		...
	 		<ul id="nav">
				<li><a title="information for prospective students" href="index.php?subsite=prospective_students"
					<?php if(parse_subsite() == "prospective_students"):?>
						class="current"
					<?php endif; ?>>Prospective Students</a>
				</li>
				<li><a title="information for current students" href="index.php?subsite=current_students"
